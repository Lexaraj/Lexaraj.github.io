...
talent[i] = [0, "Nature's Guidance", 3, 1, 1]; i++;
...
talent[i] = [0, "Elemental Devastation", 3, 1, 3]; i++;
talent[i] = [0, "Reverberation", 5, 2, 3]; i++;
talent[i] = [0, "Call of Thunder", 5, 3, 3]; i++;
talent[i] = [0, "Elemental Reach", 1, 4, 3]; i++;
...
talent[i] = [0, "Lightning Overload", 1, 3, 7, [getTalentID("Lightning Mastery"),5]]; i++;
...
talent[i] = [1, "Weapon Mastery", 5, 3, 3]; i++;
...
talent[i] = [1, "Shamanistic Focus", 1, 3, 5]; i++;
talent[i] = [1, "Elemental Impact", 5, 3, 6, [getTalentID("Shamanistic Focus"),1]]; i++;
...
rank[i] = [
"Increases the range of your Shock spells by 10 yards."
		];		
i++;	
...
rank[i] = [
"Gives your Lightning Bolt spell a 10% chance to overload you, causing your next Chain Lightning to have it's mana cost and cast time reduced by 100%."
		];		
i++;	
...
rank[i]=[
"Reduces the Mana cost of your Shock spells by 40%"
			];
i++;			

//Elemental Impact - Enhancement 
rank[i]=[
"Increases the critical strike chance of your Shock spells by 4%.",
"Increases the critical strike chance of your Shock spells by 8%.",
"Increases the critical strike chance of your Shock spells by 12%.",
"Increases the critical strike chance of your Shock spells by 16%.",
"Increases the critical strike chance of your Shock spells by 20%.",
		];
i++;	

//Stormstrike - Enhancement 
rank[i]=[
		"<span style=text-align:left;float:left;>10% base Mana</span><span style=text-align:right;float:right;>9 yd range</span><br><span style=text-align:left;float:left;>Instant cast</span><span style=text-align:right;float:right;>6 sec cooldown</span><br>An Lightning empowered strike that deals 75% weapon damage as Nature damage to the target. In addition, all Nature damage taken by the target is increased by 15%. Lasts 15 sec."
		];
i++;		
